...
public:
    ...
    SeqLib():numPair(0), totalLength(0), averageLength(0), averageInsSize(0), sdInsSize(0), averageCoverage(0), pairFP(NULL), insertLengthFP(NULL), mappedFP(NULL), mappedReadFP(NULL) {}
...
void ReadFastaHeader(std::ifstream &ifs);
void ReadFastqHeader(std::ifstream &ifs);
