...
private:
    ...
    long save(FILE *contigFP, Int2Type<KMER31>) const { return kmer31Graph.saveContigSimple(contigFP); }
    long save(FILE *contigFP, Int2Type<KMER63>) const { return kmer63Graph.saveContigSimple(contigFP); }
    long save(FILE *contigFP, Int2Type<KMER95>) const { return kmer95Graph.saveContigSimple(contigFP); }
    long save(FILE *contigFP, Int2Type<KMER127>) const { return kmer127Graph.saveContigSimple(contigFP); }
    long save(FILE *contigFP, Int2Type<KMER159>) const { return kmer159Graph.saveContigSimple(contigFP); }
    long save(FILE *contigFP, Int2Type<KMERN>) const { return kmerNGraph.saveContigSimple(contigFP); }
...
public:
    ...
    long saveContig(FILE *contigFP) const;
...
//////////////////////////////////////////////////////////////////////////////////////
template <unsigned M, unsigned N>
long GapCloseDBG<M, N>::saveContig(FILE *contigFP) const
{
    return this->save(contigFP, Int2Type<maxType>());
}
