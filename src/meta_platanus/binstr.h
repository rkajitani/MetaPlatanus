...
struct Binstr63 : public BinstrBase
{
  ...
  struct hasher
  {
    inline size_t operator()(Binstr63 b) const { return (size_t)(b.entity[0] ^ b.entity[1]); }
  };
...
struct Binstr95 : public BinstrBase
{
  ...
  struct hasher
  {
    inline size_t operator()(Binstr95 b) const { return (size_t)(b.entity[0] ^ b.entity[1] ^ b.entity[2]); }
  };
...
struct Binstr127 : public BinstrBase
{
  ...
  struct hasher
  {
    inline size_t operator()(Binstr127 b) const { return (size_t)(b.entity[0] ^ b.entity[1] ^ b.entity[2] ^ b.entity[3]); }
  };
...
struct Binstr159 : public BinstrBase
{
  ...
  struct hasher
  {
    inline size_t operator()(Binstr159 b) const { return (size_t)(b.entity[0] ^ b.entity[1] ^ b.entity[2] ^ b.entity[3] ^ b.entity[4]); }
  };
